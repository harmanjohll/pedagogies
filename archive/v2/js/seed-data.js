...
const SEED_KEY = 'cocher_v2_seeded';
const ASSESSMENT_SEED_KEY = 'cocher_v2_assessment_seeded';
...
const PD_SEED_KEY = 'cocher_v2_pd_seeded';
...
export function seedCCAIfNeeded() {
  const CCA_SEED_KEY = 'cocher_v2_cca_seeded_v3';
  if (localStorage.getItem(CCA_SEED_KEY)) return;
  const existing = JSON.parse(localStorage.getItem('cocher_v2_cca_list') || '[]');
  ...
  localStorage.setItem('cocher_v2_cca_list', JSON.stringify(sampleCCAs));
  localStorage.setItem(CCA_SEED_KEY, '1');
}

/* ══════════ Exemplar Lesson Plans ══════════ */

const LESSON_SEED_KEY = 'cocher_v2_lessons_seeded';
