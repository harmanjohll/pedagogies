...
const DASH_PREFS_KEY = 'cocher_v2_dashboard_prefs';
...
export function render(container) {
  ...
  container.querySelector('#clear-samples-btn').addEventListener('click', async () => {
    ...
    if (ok) {
      ...
      localStorage.setItem('cocher_v2_seeded', '1');
      localStorage.setItem('cocher_v2_pd_seeded', '1');
      localStorage.setItem('cocher_v2_lessons_seeded', '1');
