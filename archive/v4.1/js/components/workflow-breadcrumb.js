 ...
 * SoW → Lesson Plan → Enactment → Assessment → Reflection
...
const WORKFLOW_STEPS = [
  ...
  { id: 'enactment', label: 'Enactment', route: '/stimulus-material', icon: '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/>' },
