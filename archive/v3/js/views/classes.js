...
export function renderDetail(container, { id }) {
  ...
  function renderInner() {
    ...
    container.querySelector('#plan-from-class-btn')?.addEventListener('click', () => {
      ...
      sessionStorage.setItem('cocher_v3_plan_class_id', id);
      sessionStorage.setItem('cocher_v3_plan_class_name', freshCls.name);
      sessionStorage.setItem('cocher_v3_plan_class_subject', freshCls.subject || '');
      sessionStorage.setItem('cocher_v3_plan_class_level', freshCls.level || '');
