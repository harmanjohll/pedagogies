...
const SEED_KEY = 'cocher_v4_seeded';
const ASSESSMENT_SEED_KEY = 'cocher_v4_assessment_seeded';
...
const PD_SEED_KEY = 'cocher_v4_pd_seeded';
...
export function seedCCAIfNeeded() {
  const CCA_SEED_KEY = 'cocher_v4_cca_seeded_v3';
  if (localStorage.getItem(CCA_SEED_KEY)) return;
  const existing = JSON.parse(localStorage.getItem('cocher_v4_cca_list') || '[]');
  ...
  localStorage.setItem('cocher_v4_cca_list', JSON.stringify(sampleCCAs));
  localStorage.setItem(CCA_SEED_KEY, '1');
}

/* ══════════ Exemplar Lesson Plans ══════════ */

const LESSON_SEED_KEY = 'cocher_v4_lessons_seeded';
...
const EXEMPLAR_SEED_KEY = 'cocher_v4_exemplars_seeded_v1';
const DAY = 86400000;
...
const PORTAL_SEED_KEY = 'cocher_v4_portal_demos_seeded_v1';
...
export function seedPortalDemosIfNeeded() {
  ...
  try {
    const cceKey = 'cocher_v4_cce_discussions';
