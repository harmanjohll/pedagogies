...
const SEED_KEY = 'cocher_v7_seeded';
const ASSESSMENT_SEED_KEY = 'cocher_v7_assessment_seeded';
...
const PD_SEED_KEY = 'cocher_v7_pd_seeded';
...
export function seedCCAIfNeeded() {
  const CCA_SEED_KEY = 'cocher_v7_cca_seeded_v4'; // v4: added Scouts
  if (localStorage.getItem(CCA_SEED_KEY)) return;
  const existing = JSON.parse(localStorage.getItem('cocher_v7_cca_list') || '[]');
  ...
  localStorage.setItem('cocher_v7_cca_list', JSON.stringify(sampleCCAs));
  localStorage.setItem(CCA_SEED_KEY, '1');
}

/* ══════════ Exemplar Lesson Plans ══════════ */

const LESSON_SEED_KEY = 'cocher_v7_lessons_seeded';
...
const EXEMPLAR_SEED_KEY = 'cocher_v7_exemplars_seeded_v1';
const DAY = 86400000;
...
const PORTAL_SEED_KEY = 'cocher_v7_portal_demos_seeded_v2';
...
export function seedPortalDemosIfNeeded() {
  ...
  try {
    const cceKey = 'cocher_v7_cce_discussions';
