...
export function renderDetail(container, { id }) {
  ...
  function renderInner() {
    ...
    container.querySelector('#plan-from-class-btn')?.addEventListener('click', () => {
      ...
      sessionStorage.setItem('cocher_v6_1_plan_class_id', id);
      sessionStorage.setItem('cocher_v6_1_plan_class_name', freshCls.name);
      sessionStorage.setItem('cocher_v6_1_plan_class_subject', freshCls.subject || '');
      sessionStorage.setItem('cocher_v6_1_plan_class_level', freshCls.level || '');
    ...
    container.querySelector('#portrait-plan-btn')?.addEventListener('click', () => {
      sessionStorage.setItem('cocher_v6_1_plan_class_id', freshCls.id);
      sessionStorage.setItem('cocher_v6_1_plan_class_name', freshCls.name);
      sessionStorage.setItem('cocher_v6_1_plan_class_subject', freshCls.subject || '');
      sessionStorage.setItem('cocher_v6_1_plan_class_level', freshCls.level || '');
      navigate('/lesson-planner');
