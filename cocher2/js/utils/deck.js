 ...
 * ('cocher2_decks' / 'cocher2_audio_clips'); the bulky payloads (deck HTML
...
const DECKS_KEY = 'cocher2_decks';
const AUDIO_KEY = 'cocher2_audio_clips';
 ...
 * localStorage 'cocher2_decks'. Resolves the metadata entry, or null when
 ...
 * localStorage 'cocher2_audio_clips'. Resolves the metadata entry or null.
 */
...
/** Delete a stored deck: its IndexedDB payload AND its cocher2_decks metadata
