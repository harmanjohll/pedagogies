...
const VERSION = 'v1.10';                       // match APP_VERSION in js/version.js
const CACHE_PREFIX = 'cocher2-';
const CACHE_NAME = CACHE_PREFIX + VERSION;  // e.g. 'cocher2-v1.0'
